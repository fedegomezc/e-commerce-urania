...
const CartContextProvider = ({ children }) => {
    ...
    const quantityProd = cartList.reduce((acc, product) => acc + product.quantityToAdd, 0);

  return (
        <CartContext.Provider value={{cartList, addToCart, deleteItem, removeList, total, quantityProd}}>
                { children }
